			...
			<div className="container px-4 py-5" id="featured-3">
				<div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
					<div className="feature col d-flex flex-column">
						<div className="border rounded-4 text-bg-secondary fs-4 mb-3 py-2 px-3 mx-auto">
					...
					<div className="feature col d-flex flex-column">
						...
						<p>Como usuario podrás buscar todo tipo de servicios en un par de clics, filtrando por tipo de servicio o cercanía.
